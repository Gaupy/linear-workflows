...
case $1 in
	...
	for iter in `seq 1 ${11}`; do
		...
		GSL_RNG_TYPE=ranlux GSL_RNG_SEED=$r ggen -l=0 generate-graph gnp $5 $7 | GSL_RNG_TYPE=ranlux GSL_RNG_SEED=$r ggen -l=0 add-property exponential $8 > dag_$1_$2_$3_$5_$6_$7_$8_$9_${10}.dag
	...
	for iter in `seq 1 ${11}`; do
		...
		./script.native  param_$1_$2_$3_$5_$6_$7_$8_$9_${10} dag_$1_$2_$3_$5_$6_$7_$8_$9_${10}.dag
		rm dag_$1_$2_$3_$5_$6_$7_$8_$9_${10}.dag
	done
	;;
	3) #graphs are fifo
	for iter in `seq 1 ${11}`; do
